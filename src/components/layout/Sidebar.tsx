...
export function Sidebar() {
  ...
  return (
    <aside
      id="sidebar"
      className="flex flex-col w-[240px] min-w-[240px] bg-white border-r border-gray-200 h-screen sticky top-0"
    >

      <div
        className="flex items-center gap-3 px-5 py-5 cursor-pointer border-b border-gray-100"
